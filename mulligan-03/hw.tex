...
\begin{itemize}
    ...
    the largest CV score with 1,000 samples.  We can see here that the CV score increased with the increase 
    in the number of neurons.  The value of $\eta$ was fairly consistent at $\eta = 0.1$.  Therefore, I 
    believe that the performance of the network increased with an increase in the number of neurons.
